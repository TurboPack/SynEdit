...
// (DO NOT EDIT: machine generated header) 'SynUsp10.pas' rev: 28.00 (Windows)
...
extern DELPHI_PACKAGE HRESULT __stdcall ScriptCacheGetHeight(HDC hdc, PScriptCache psc, System::PLongInt tmHeight);
